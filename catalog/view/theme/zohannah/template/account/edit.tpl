...
.btn-primary{border:0;background:#000;text-transform:uppercase}
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="buttons clearfix">
              ...
              <div class="pull-right">
                <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary" style="background:#000;color:#fff;border-radius:0" />
              </div>
            </div>
          </form>        
