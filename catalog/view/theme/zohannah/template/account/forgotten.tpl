      ...
      <div class="nix-hero-copy-wrapper">
         <div class="nix-hero-copy">
                ...
                <div class="row" style="text-align:center">
                    ...
                    <input type="email" style="width:100%;margin:0 auto;text-align:center" name="email" value="" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" />
                    <a href="<?php echo $back; ?>" style="background:#333;color:#fff" class="btn nix-hero-button"><?php echo $button_back; ?></a>
