  ...
  <div class="hero-nav-container nix-hero-container">
    <div class="nix-hero-copy-wrapper">
      <div class="nix-hero-copy">
        <h1 class="nix-hero-head">AW15</h1>
        <p class="nix-hero-meta">COLLECTION</p>
        <p class="nix-hero-copy-text">Some of us are born to wander.</p>
        <a class="nix-hero-button" href=""> Shop Now </a> </div>
    </div>
  </div>
</div>
<?php echo $footer; ?>